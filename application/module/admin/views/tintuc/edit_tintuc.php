    ...
    <div class="row-fluid">
      <div class="span12">
        ...
        <div class="widget-content nopadding">
          <form  enctype="multipart/form-data" class="form-horizontal" method="post" action="<?php echo $linkEditNews; ?>" name="" id="" novalidate="novalidate">
            <input name="form[token]" type="hidden" value="<?php echo time();?>" />
            <div class="control-group">
              <label class="control-label">Title</label>
              <div class="controls">
                <input style="width: 75%" type="text" value="<?php echo $new['title']; ?>" name="form[title]" id="title">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                 <img src="<?php echo '../public/images/news/'.$new['image']; ?>" alt="<?php echo $new['title']; ?>">
                  <br><br>
              </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
                 <p style="color: #f22e2e"><?php echo isset($errors['content'])?$errors['content']:''; ?></p>
                <textarea class="ckeditor" required name="form[description]" id="description"><?php echo $new['content']; ?></textarea>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <label>
                  <input type="checkbox" value="1" <?php if($new['status']==1) echo 'checked'; ?>  name="form[status]" />
                </label>
              </div>
            </div>
