    ...
    <div class="row-fluid">
      <div class="span12">
        ...
        <div class="widget-content nopadding">
          <form enctype="multipart/form-data" class="form-horizontal" method="post" action="<?php echo $linlEdit; ?>" name="" id="" novalidate="novalidate">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" value="<?php echo $product['product_name']; ?>" name="form[product_name]" id="product_name">
             ...
             <div class="control-group">
              ...
              <div class="controls">
                  <input type="hidden" name="form[current_image]" id="current_image" value="<?php echo $product['image']; ?>">
                  <img  src="<?php echo '../public/images/products/'.$product['image']; ?>" alt="<?php echo $product['product_name']; ?>">
                  <br><br>
              </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" value="<?php echo $product['price']; ?>" name="form[price]" id="price">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" value="<?php echo $product['quantity']; ?>" name="form[quantity]" id="quantity">
              ...
              <div class="controls">
                <select style="width: 30%" name="form[cpu]" id="cpu">
                  <?php foreach($cpus as $cpu){ ?>
                    <option <?php if($cpu['id']==$product['cpu']) echo "selected"; ?> value="<?php echo $cpu['id']; ?>"><?php echo $cpu['cpu_name']; ?></option>
                  <?php } ?>
                </select>
              </div>
            </div>
              ...
              <div class="controls">
               <select style="width: 30%" class="col-md-3" name="form[vga]" id="vga">
                   <?php foreach($vgas as $vga){ ?>
                    <option <?php if($vga['id']=$product['vga']) echo 'selected'; ?> value="<?php echo $vga['id']; ?>"><?php echo $vga['vga_name']; ?></option>
                  <?php } ?>
                </select>
              </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
                <select style="width: 30%" name="form[monitor]" id="monitor">
                    ...
                    <option <?php if($monitor['id']=$product['monitor']) echo 'selected'; ?> value="<?php echo $monitor['id']; ?>"><?php echo $monitor['monitor_name']; ?></option>
                  <?php } ?>
                </select>
              </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <textarea class="" required name="form[description]" id="description"><?php echo $product['description']; ?></textarea>
