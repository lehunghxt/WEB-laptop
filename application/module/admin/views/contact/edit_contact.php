<?php 
  $linkEditCate    = URL::createLink('admin', 'contact', 'edit');  
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="" name="addContact_validate" id="addContact_validate" novalidate="novalidate">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="form[contact_name]" id="contact_name" value="<?php echo $this->category['title']; ?>">
                </div>
              </div>
              <div class="control-group">
              <label class="control-label">Nội dung</label><br>
              <div class="controls">
                <textarea class="ckeditor" required name="form[description]" id="description"><?php echo $this->category['content']; ?></textarea>
              ...
              <div class="control-group">
                <label class="control-label">Hiển Thị</label>
                 <div class="controls">
                <label>
                  <input type="checkbox" value="1" <?php if($this->category['status'] == 1) {echo ' checked';}?>  name="form[status]" />
              </label>
              </div>
              </div>
